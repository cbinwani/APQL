...
public class ManagerPortalEndpoint {
    ...
    public ManagerPortalEndpoint(final DeploymentService deploymentService, final PluginService pluginService,
            ...
            final SecurityService secSrv, final WorkspaceService wrkSrv, final UserInterfaceHelper uiHelper, final PQLService pqlService, final DatabaseService dbService) {
     ...
     * (non-Javadoc)
     *
     * @see org.apromore.portal.service_portal1.ManagerPortalPortType#searchForSimilarProcesses(SearchForSimilarProcessesInputMsgType payload )*
     */
...
//            pqlService.indexOneModel(editType.getProcessName(),editType.getProcessId(),currentVersion,editType.getNewBranchName(),null,false);
//            pqlService.update(editType.getProcessId(),editType.getProcessName(),secSrv.getUserByName(editType.getUsername()),natType,currentVersion,editType.getNewBranchName());
     ...
     * (non-Javadoc)
     *
     * @see org.apromore.portal.service.ManagerPortalPortType#readDomains(ReadDomainsInputMsgType payload )*
     */
    ...
    /*
     * (non-Javadoc)
     * @see org.apromore.portal.service.ManagerPortalPortType#ReadUserByUsername(ReadUserInputMsgType payload )
     */
    ...
    /* (non-Javadoc)
    * @see org.apromore.portal.service.ManagerPortalPortType#readUser(ReadUserInputMsgType  payload )
    */
     ...
     * (non-Javadoc)
     *
     * @see org.apromore.portal.service.ManagerPortalPortType#readProcessSummaries(ReadProcessSummariesInputMsgType payload )*
     */
     ...
     * (non-Javadoc)
     *
     * @see org.apromore.portal.service.ManagerPortalPortType#runAPQLExpression(RunAPQLInputMsgType payload )*
     */
