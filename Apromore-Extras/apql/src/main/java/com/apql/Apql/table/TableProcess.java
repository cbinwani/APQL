...
public class TableProcess extends JPanel implements Observer, Serializable {
    ...
    public void setHeader(int widthHeader, int heightHeader, String... header){
        ...
        JScrollPane pane=new JScrollPane(panelHeader);
        layout.putConstraint(SpringLayout.NORTH,this,0,SpringLayout.NORTH,panelHeader);
        layout.putConstraint(SpringLayout.NORTH,panelHeader,0,SpringLayout.NORTH,panelRows);
