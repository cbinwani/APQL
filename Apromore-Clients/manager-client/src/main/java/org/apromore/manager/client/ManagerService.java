...
public interface ManagerService {
    ...
    /**
     * Read all the users from the apromore portal.
     * @return the UsernameType from the Webservice
     */
    UsernamesType readAllUsers();

    /**
     * Reads all the different domains from the apromore portal.
     * @return the DomainsType from the WebService
     */
    DomainsType readDomains();

    /**
     * Reads all the Native Types from the apromore portal.
    ...
    /**
     * Takes an APQL expression and tells the portal to excute it and return a result.
