...
/**
 * Implementation of a tenant portal in the file accessing Oryx backend.
 * 
...
public class FsTenantManager extends FsBusinessObjectManager {
	...
	public FsTenant createTenant(FsAccount account, String string, String id) throws TenantException {
		throw new UnsupportedOperationException("This tenant portal does not support the creation of new tenants.");
	}
